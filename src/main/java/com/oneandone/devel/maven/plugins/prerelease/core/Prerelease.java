...
import com.oneandone.devel.maven.plugins.prerelease.util.Mailer;
import com.oneandone.devel.maven.plugins.prerelease.util.Subversion;
import com.oneandone.devel.maven.plugins.prerelease.util.Transform;
...
public class Prerelease {
    ...
    public void build(final Log log, boolean alwaysUpdate, boolean promoting, Properties userProperties) throws Exception {
        ...
        mvn = com.oneandone.devel.maven.plugins.prerelease.util.Maven.mvn(checkout, userProperties);
